...
static LiftedTaskPtr compute_lifted_task(const fs::path& domain_filepath, const fs::path& problem_filepath)
{
...
TEST(TyrTests, TyrPlanningLiftedTaskAgricola)
{
    ...
    EXPECT_EQ(lifted_task->get_initial_node().get_labeled_successor_nodes().size(), 8);
}
...
TEST(TyrTests, TyrPlanningLiftedTaskAirport)
{
    ...
    EXPECT_EQ(lifted_task->get_initial_node().get_labeled_successor_nodes().size(), 2);
}
...
TEST(TyrTests, TyrPlanningLiftedTaskAssembly)
{
    ...
    EXPECT_EQ(lifted_task->get_initial_node().get_labeled_successor_nodes().size(), 3);
}
...
TEST(TyrTests, TyrPlanningLiftedTaskBarman)
{
    ...
    EXPECT_EQ(lifted_task->get_initial_node().get_labeled_successor_nodes().size(), 4);
}
...
TEST(TyrTests, TyrPlanningLiftedTaskFoCounters)
{
    ...
    EXPECT_EQ(lifted_task->get_initial_node().get_labeled_successor_nodes().size(), 9);
}
...
TEST(TyrTests, TyrPlanningLiftedTaskGrid)
{
    ...
    EXPECT_EQ(lifted_task->get_initial_node().get_labeled_successor_nodes().size(), 1);
}
...
TEST(TyrTests, TyrPlanningLiftedTaskGripper)
{
    ...
    EXPECT_EQ(lifted_task->get_initial_node().get_labeled_successor_nodes().size(), 6);
}
...
TEST(TyrTests, TyrPlanningLiftedTaskHiking)
{
    ...
    EXPECT_EQ(lifted_task->get_initial_node().get_labeled_successor_nodes().size(), 18);
}
...
TEST(TyrTests, TyrPlanningLiftedTaskPathways)
{
    ...
    EXPECT_EQ(lifted_task->get_initial_node().get_labeled_successor_nodes().size(), 16);
}
...
TEST(TyrTests, TyrPlanningLiftedTaskRefuelAdl)
{
    ...
    EXPECT_EQ(lifted_task->get_initial_node().get_labeled_successor_nodes().size(), 5);
}
...
TEST(TyrTests, TyrPlanningLiftedTaskSchedule)
{
    ...
    EXPECT_EQ(lifted_task->get_initial_node().get_labeled_successor_nodes().size(), 44);
}
...
TEST(TyrTests, TyrPlanningLiftedTaskZenotravel)
{
    ...
    EXPECT_EQ(lifted_task->get_initial_node().get_labeled_successor_nodes().size(), 7);
}
}