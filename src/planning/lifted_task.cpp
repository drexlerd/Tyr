...
LiftedTask::LiftedTask(std::shared_ptr<formalism::Repository> repository, Index<formalism::planning::Task> task_index) :
    TaskMixin(std::move(repository), task_index)
{
}
...
GroundTask LiftedTask::get_ground_task() { return GroundTask(m_repository, m_task_index); }
