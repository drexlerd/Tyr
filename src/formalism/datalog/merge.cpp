...
template std::pair<Index<Predicate<StaticTag>>, bool> merge_d2d(View<Index<Predicate<StaticTag>>, Repository> element, MergeContext& context);
template std::pair<Index<Predicate<FluentTag>>, bool> merge_d2d(View<Index<Predicate<FluentTag>>, Repository> element, MergeContext& context);
...
template std::pair<Index<Atom<StaticTag>>, bool> merge_d2d(View<Index<Atom<StaticTag>>, Repository> element, MergeContext& context);
template std::pair<Index<Atom<FluentTag>>, bool> merge_d2d(View<Index<Atom<FluentTag>>, Repository> element, MergeContext& context);
...
template std::pair<Index<GroundAtom<StaticTag>>, bool> merge_d2d(View<Index<GroundAtom<StaticTag>>, Repository> element, MergeContext& context);
template std::pair<Index<GroundAtom<FluentTag>>, bool> merge_d2d(View<Index<GroundAtom<FluentTag>>, Repository> element, MergeContext& context);
...
template std::pair<Index<Literal<StaticTag>>, bool> merge_d2d(View<Index<Literal<StaticTag>>, Repository> element, MergeContext& context);
template std::pair<Index<Literal<FluentTag>>, bool> merge_d2d(View<Index<Literal<FluentTag>>, Repository> element, MergeContext& context);
...
template std::pair<Index<GroundLiteral<StaticTag>>, bool> merge_d2d(View<Index<GroundLiteral<StaticTag>>, Repository> element, MergeContext& context);
template std::pair<Index<GroundLiteral<FluentTag>>, bool> merge_d2d(View<Index<GroundLiteral<FluentTag>>, Repository> element, MergeContext& context);
...
template std::pair<Index<Function<StaticTag>>, bool> merge_d2d(View<Index<Function<StaticTag>>, Repository> element, MergeContext& context);
template std::pair<Index<Function<FluentTag>>, bool> merge_d2d(View<Index<Function<FluentTag>>, Repository> element, MergeContext& context);
...
template std::pair<Index<FunctionTerm<StaticTag>>, bool> merge_d2d(View<Index<FunctionTerm<StaticTag>>, Repository> element, MergeContext& context);
template std::pair<Index<FunctionTerm<FluentTag>>, bool> merge_d2d(View<Index<FunctionTerm<FluentTag>>, Repository> element, MergeContext& context);
...
template std::pair<Index<GroundFunctionTerm<StaticTag>>, bool> merge_d2d(View<Index<GroundFunctionTerm<StaticTag>>, Repository> element, MergeContext& context);
template std::pair<Index<GroundFunctionTerm<FluentTag>>, bool> merge_d2d(View<Index<GroundFunctionTerm<FluentTag>>, Repository> element, MergeContext& context);
...
template std::pair<Index<GroundFunctionTermValue<StaticTag>>, bool> merge_d2d(View<Index<GroundFunctionTermValue<StaticTag>>, Repository> element,
                                                                              MergeContext& context);
template std::pair<Index<GroundFunctionTermValue<FluentTag>>, bool> merge_d2d(View<Index<GroundFunctionTermValue<FluentTag>>, Repository> element,
                                                                              MergeContext& context);
...
merge_d2d(View<Index<UnaryOperator<OpSub, Data<FunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<UnaryOperator<OpSub, Data<GroundFunctionExpression>>>, bool>
merge_d2d(View<Index<UnaryOperator<OpSub, Data<GroundFunctionExpression>>>, Repository> element, MergeContext& context);
...
merge_d2d(View<Index<BinaryOperator<OpAdd, Data<FunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpSub, Data<FunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpSub, Data<FunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpMul, Data<FunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpMul, Data<FunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpDiv, Data<FunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpDiv, Data<FunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpEq, Data<FunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpEq, Data<FunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpNe, Data<FunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpNe, Data<FunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpGe, Data<FunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpGe, Data<FunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpGt, Data<FunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpGt, Data<FunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpLe, Data<FunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpLe, Data<FunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpLt, Data<FunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpLt, Data<FunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpAdd, Data<GroundFunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpAdd, Data<GroundFunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpSub, Data<GroundFunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpSub, Data<GroundFunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpMul, Data<GroundFunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpMul, Data<GroundFunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpDiv, Data<GroundFunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpDiv, Data<GroundFunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpEq, Data<GroundFunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpEq, Data<GroundFunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpNe, Data<GroundFunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpNe, Data<GroundFunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpGe, Data<GroundFunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpGe, Data<GroundFunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpGt, Data<GroundFunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpGt, Data<GroundFunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpLe, Data<GroundFunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpLe, Data<GroundFunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<BinaryOperator<OpLt, Data<GroundFunctionExpression>>>, bool>
merge_d2d(View<Index<BinaryOperator<OpLt, Data<GroundFunctionExpression>>>, Repository> element, MergeContext& context);
...
merge_d2d(View<Index<MultiOperator<OpAdd, Data<FunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<MultiOperator<OpMul, Data<FunctionExpression>>>, bool>
merge_d2d(View<Index<MultiOperator<OpMul, Data<FunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<MultiOperator<OpAdd, Data<GroundFunctionExpression>>>, bool>
merge_d2d(View<Index<MultiOperator<OpAdd, Data<GroundFunctionExpression>>>, Repository> element, MergeContext& context);
template std::pair<Index<MultiOperator<OpMul, Data<GroundFunctionExpression>>>, bool>
merge_d2d(View<Index<MultiOperator<OpMul, Data<GroundFunctionExpression>>>, Repository> element, MergeContext& context);
...
template Data<ArithmeticOperator<Data<FunctionExpression>>> merge_d2d(View<Data<ArithmeticOperator<Data<FunctionExpression>>>, Repository> element,
                                                                      MergeContext& context);
template Data<ArithmeticOperator<Data<GroundFunctionExpression>>> merge_d2d(View<Data<ArithmeticOperator<Data<GroundFunctionExpression>>>, Repository> element,
                                                                            MergeContext& context);
...
template Data<BooleanOperator<Data<FunctionExpression>>> merge_d2d(View<Data<BooleanOperator<Data<FunctionExpression>>>, Repository> element,
                                                                   MergeContext& context);
template Data<BooleanOperator<Data<GroundFunctionExpression>>> merge_d2d(View<Data<BooleanOperator<Data<GroundFunctionExpression>>>, Repository> element,
                                                                         MergeContext& context);
