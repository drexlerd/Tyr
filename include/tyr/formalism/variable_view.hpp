...
public:
    ...
    View(Index<formalism::Variable> handle, const C& context) : m_context(&context), m_handle(handle) {}

    const auto& get_data() const { return formalism::get_repository(*m_context)[m_handle]; }
