...
{
public:
    PlanningFDRTask(FDRTaskView task, GeneralFDRContext fdr_context, std::shared_ptr<Repository> repository, PlanningDomain domain) :
...
private:
    ...
    FDRTaskView m_task;
    GeneralFDRContext m_fdr_context;
