...
#ifndef TYR_FORMALISM_PLANNING_FDR_AXIOM_DATA_HPP_
#define TYR_FORMALISM_PLANNING_FDR_AXIOM_DATA_HPP_
...
template<>
struct Data<formalism::FDRAxiom>
{
    using Tag = formalism::FDRAxiom;

    Index<formalism::FDRAxiom> index;
    Index<formalism::Axiom> axiom;
    Index<formalism::FDRConjunctiveCondition> body;
    Data<formalism::FDRFact<formalism::DerivedTag>> head;

    Data() = default;
    Data(Index<formalism::FDRAxiom> index,
         Index<formalism::Axiom> axiom,
         Index<formalism::FDRConjunctiveCondition> body,
         Data<formalism::FDRFact<formalism::DerivedTag>> head) :
        index(index),
