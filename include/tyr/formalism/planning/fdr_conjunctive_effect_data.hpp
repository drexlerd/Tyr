...
#ifndef TYR_FORMALISM_PLANNING_FDR_CONJUNCTIVE_EFFECT_DATA_HPP_
#define TYR_FORMALISM_PLANNING_FDR_CONJUNCTIVE_EFFECT_DATA_HPP_
...
template<>
struct Data<formalism::FDRConjunctiveEffect>
{
    using Tag = formalism::FDRConjunctiveEffect;

    Index<formalism::FDRConjunctiveEffect> index;
    ...
    Data() = default;
    Data(Index<formalism::FDRConjunctiveEffect> index,
         DataList<formalism::FDRFact<formalism::FluentTag>> facts,
         DataList<formalism::GroundNumericEffectOperator<formalism::FluentTag>> numeric_effects,
