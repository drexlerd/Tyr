...
#ifndef TYR_FORMALISM2_GROUND_FUNCTION_TERM_VALUE_PROXY_HPP_
#define TYR_FORMALISM2_GROUND_FUNCTION_TERM_VALUE_PROXY_HPP_

#include "tyr/formalism2/declarations.hpp"
#include "tyr/formalism2/ground_function_term_proxy.hpp"
...
class Proxy<formalism::GroundFunctionTermValue<T>, C>
{
private:
    const C* context;
