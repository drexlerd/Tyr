...
#ifndef TYR_FORMALISM2_GROUND_LITERAL_PROXY_HPP_
#define TYR_FORMALISM2_GROUND_LITERAL_PROXY_HPP_
...
class Proxy<formalism::GroundLiteral<T>, C>
{
private:
    const C* context;
...
public:
    ...
    auto get_atom() const { return Proxy<formalism::GroundAtom<T>, C>(get().atom_index, *context); }
