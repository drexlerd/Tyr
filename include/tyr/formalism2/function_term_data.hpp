...
#ifndef TYR_FORMALISM2_FUNCTION_TERM_DATA_HPP_
#define TYR_FORMALISM2_FUNCTION_TERM_DATA_HPP_
...
struct Data<formalism::FunctionTerm<T>>
{
    ...
    Data() = default;
    Data(Index<formalism::FunctionTerm<T>> index, DataList<formalism::Term> terms) : index(index), terms(std::move(terms)) {}
