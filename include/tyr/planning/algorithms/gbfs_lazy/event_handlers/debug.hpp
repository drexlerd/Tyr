...
#ifndef TYR_PLANNING_ALGORITHMS_GBFS_LAZY_EVENT_HANDLERS_DEBUG_HPP_
#define TYR_PLANNING_ALGORITHMS_GBFS_LAZY_EVENT_HANDLERS_DEBUG_HPP_
...
class DebugEventHandler : public EventHandlerBase<DebugEventHandler<Task>, Task>
{
private:
    /* Implement AlgorithmEventHandlerBase interface */
    friend class EventHandlerBase<DebugEventHandler<Task>, Task>;
...
public:
    DebugEventHandler(bool quiet = true);

    static DebugEventHandlerPtr<Task> create(bool quiet = true);
};
