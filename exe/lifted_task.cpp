...
int main(int argc, char** argv)
{
    ...
    auto add_heuristic = planning::AddHeuristic<planning::LiftedTask>::create(lifted_task);
    add_heuristic->set_goal(lifted_task->get_task().get_goal());
    auto max_heuristic = planning::MaxHeuristic<planning::LiftedTask>::create(lifted_task);
