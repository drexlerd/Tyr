...
exp = Experiment("gbfs_combine_8_9")
...
exp.add_fetcher("../8-2026-1-8-gbfs_lazy-profiling-classical-combined-eval", filter=rename_algorithm)
exp.add_fetcher("../9-2026-1-8-gbfs_lazy-profiling-classical-combined-eval")
